...
function Deactivate_BF(){
    ...
    it("Click on Deactivate button.", function () {
    cy.get('[class="dropdown-style dropdown-menu show dropdown-menu-end"]').find('a').contains("Deactivate").click()
    })
